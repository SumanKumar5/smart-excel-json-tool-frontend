...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="relative mt-auto bg-slate-900 dark:bg-slate-950 text-white py-10">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <Link
              to="/"
              className="flex items-center space-x-2 text-xl font-medium mb-4 hover:text-blue-400 transition-colors"
            >
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link
                  to="/excel-to-json"
                  className="text-slate-300 dark:text-slate-400 hover:text-white transition-colors flex items-center space-x-2"
                >
